          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total SP</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Completed SP</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SP Completion</th>
              ...
              {data.length === 0 ? (
                ...
                data.map((project, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{project.totalTasksAssigned}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{project.completedTasks}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{project.totalStoryPointsAssigned}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{project.completedStoryPoints}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <div className="flex items-center">
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
