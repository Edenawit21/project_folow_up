              ...
              privileges.map((p) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold dark:bg-green-900/30 ">
                      {p.action}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4 text-right text-sm font-medium">
                    <div className="flex justify-end space-x-4">
                      <button
                        ...
                        className=" dark:text-white dark:hover:text-indigo-300"
                      >
                        <Pencil size={18} />
                      </button>
