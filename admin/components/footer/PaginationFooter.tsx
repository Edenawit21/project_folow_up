  ...
  return (
    <div className="mt-6 flex justify-center space-x-1 text-sm select-none">
      ...
      <button
        ...
        onClick={() => onPageChange(currentPage + 1)}
        className="px-3 py-1 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 hover:bg-blue-100 dark:hover:bg-green-700 hover:text-green-700 dark:hover:text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-400"
      >
        Next
      </button>
    </div>
