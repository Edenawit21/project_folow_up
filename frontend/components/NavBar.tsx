      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative w-48">
          ...
          <input
            type="search"
            placeholder="Search..."
            className="w-full rounded-md bg-gray-100 dark:bg-gray-800 text-[var(--text)] pl-8 pr-2 py-2 placeholder-[var(--muted)] focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      </div>
